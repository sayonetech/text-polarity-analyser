...
def replacement_patterns(text):
    """
    Replace contraction words.Add more to this list to increase accuracy
    """
...
def replace(word, pos=None):
    """
    Fucntion to check if a antonym is available for a word
    """
    antonyms = set()
...
def regex_search(filename, term):
    """
    To check if a given word term is present in the file
    """
